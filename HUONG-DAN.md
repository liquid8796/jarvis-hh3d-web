...
| **Nhiệm vụ ngày** | Điểm Danh, Hoang Vực, Phúc Lợi Đường, Thí Luyện, Bí Cảnh, Tế Lễ, Phúc Lợi VIP, Vòng Quay, Vấn Đáp. Tick là xong, không phải chỉnh gì. Các nhiệm vụ có bản thường nằm trong tab **Tài khoản thường**; Mê Cung dùng chung một bộ tuỳ chọn cho cả hai hạng. Hoang Vực tự hiểu component **Hồi chiêu** mới dạng `g/p/s` cho cả VIP và thường. |
