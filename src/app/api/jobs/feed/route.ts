...
import { getJobFeed } from "@/lib/services/dashboard";
 ...
 * giữ route này cho tab/bản deploy cũ đang mở trong lúc rollout. Đây vẫn là một READ
...
export async function GET(request: NextRequest) {
  ...
  return NextResponse.json(await getJobFeed(user.id, after));
}
